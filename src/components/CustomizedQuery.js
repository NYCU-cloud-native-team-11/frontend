...
function CustomizedQuery() {
  ...
  useEffect(() => {
    const url = "/keywords/TSMC/"+moment(Date.parse(dateRange[0])).format("YYYYMMDD")+"-"+moment(Date.parse(dateRange[1])).format("YYYYMMDD");
    // console.log(url)
  ...
  useEffect(() => {
    const url = "/keywords/Applied Materials/"+moment(Date.parse(dateRange[0])).format("YYYYMMDD")+"-"+moment(Date.parse(dateRange[1])).format("YYYYMMDD");
    // console.log(url)
    const fetchData = async () => {
      try {
        const response = await api.get(url)
  ...
  useEffect(() => {
    const url = "/keywords/ASML/"+moment(Date.parse(dateRange[0])).format("YYYYMMDD")+"-"+moment(Date.parse(dateRange[1])).format("YYYYMMDD");
    // console.log(url)
    const fetchData = async () => {
      try {
        const response = await api.get(url)
  ...
  useEffect(() => {
    const url = "/keywords/SUMCO/"+moment(Date.parse(dateRange[0])).format("YYYYMMDD")+"-"+moment(Date.parse(dateRange[1])).format("YYYYMMDD");
    // console.log(url)
    const fetchData = async () => {
      try {
        const response = await api.get(url)
